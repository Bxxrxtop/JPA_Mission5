...
public class QUserMission extends EntityPathBase<UserMission> {
    ...
    private static final long serialVersionUID = 939566555L;
    ...
    public final com.example.jpa.domain.common.QMission mission;

    public final EnumPath<com.example.jpa.domain.enums.MissionStatus> status = createEnum("status", com.example.jpa.domain.enums.MissionStatus.class);
